...
TankRobot::TankRobot(TankDrivetrain& d, RollerIntake& in, Indexer* i, Turret* t, VisionSensor* vis, TeamColor tc) : 
...
void TankRobot::pollController(bool dualDriver)
{
    ...
    manualAim = (driver.get_digital_new_press(pros::E_CONTROLLER_DIGITAL_R1)) ? !manualAim : manualAim;
